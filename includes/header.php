          ...
          <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#"><i class="material-icons">inbox</i></a>
                </li>
                 <li class="nav-item">
                ...
                <li class="nav-item">
                    <div class="dropdown show">
                <a class="nav-link" href="#" role="button" id="dropdownSearch" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="material-icons">search</i></a>
                    <div class="dropdown-menu" aria-labelledby="dropdownSearch">
                            <input class="form-control searchCustom" type="search" placeholder="Search" aria-label="Search">
                    </div>
                    </div>
                </li>
              </ul>
